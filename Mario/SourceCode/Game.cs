...
namespace Mario
{
    internal class Game
    {
        public static System.IntPtr _Renderer = System.IntPtr.Zero;
        public static int _ScrollSpeed = 0;
        public static Map _CurrentLevel;
        public static int[] immpasableBlocks = new int[] {1, 2, 3, 4, 5, 6, 7, 8, 23, 25, 26};
        ...
        public void Init(string title, int x, int y, int w, int h, SDL.SDL_WindowFlags flags)
        {
            ...
            fontRectangle.w = 120;
            fontRectangle.h = 24;
            fontSurface = SDL_ttf.TTF_RenderText_Solid(fontPointer, "000000", fontColor);
            ...
            fontRectangle6.h = 24;
            fontSurface = SDL_ttf.TTF_RenderText_Solid(fontPointer, "  400", fontColor);
            ...
            SDL.SDL_FreeSurface(fontSurface);
            fontRectangle8.x = App.screenWidth / 2;
            fontRectangle8.y = App.screenHeight / 2;
            ...
            SDL.SDL_FreeSurface(fontSurface);
            fontRectangle9.x = App.screenWidth / 2;
            fontRectangle9.y = App.screenHeight / 2 - 24;
            ...
            SDL.SDL_FreeSurface(fontSurface);
            fontRectangle10.x = App.screenWidth / 2;
            fontRectangle10.y = App.screenHeight / 2 - 48;
                    ...
                    case SDL.SDL_EventType.SDL_MOUSEBUTTONDOWN:
                        switch (e.button.button)
                        {
                            case (byte)SDL.SDL_BUTTON_LEFT:
                                ...
                                System.IntPtr music = SDL_mixer.Mix_LoadWAV("Assets/Music/OverworldTheme.wav");
